...
The release is intentionally data-focused. It provides the experimental records,
field definitions, paper-to-file mapping, and provenance needed to inspect the
reported evidence with standard CSV/JSON tools. It does not distribute project
...
> The de-identified experimental records supporting the figures and tables,
> together with a data dictionary and provenance documentation, are available
> in the GitHub repository *Integrated QGP Evaluation Data* at
...
> operational QKD KeyIds, and key-management entity (KME)/SSH metadata are not
> publicly released.
